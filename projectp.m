...
p.smallP= 0.2; % small phytoplankton (μm) ESD Equivalent shperical diameter
p.largeP= 20; %large phytoplankton cell (μm) ESD
p.smallZ= 2; %small zooplankton cells (μm) ESD
p.largeZ= 210; %large zooplankton cell size (μm) ESD
p.Pgrid=30; %No. of phytoplankton size classes
p.Zgrid=30; %No. of zooplankton size classes
...
p.initP=ones(p.Pgrid,1); %initial concentration of P (μMolN/m^3)
p.initZ=ones(p.Zgrid,1); %initial concentration of Z (μMolN/m^3)
